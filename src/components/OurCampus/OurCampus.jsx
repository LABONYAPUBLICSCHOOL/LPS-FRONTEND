    ...
    <div className="campus-container">
      ...
      <div className="campus-section fade-up">
        ...
        <p>
          ...
          environment with ergonomically designed chairs and tables sourced from
          Germany. Classrooms are equipped with cutting-edge technology like
          interactive Smart Boards, LCD projectors, and HDTVs, enhancing
      ...
      <div className="campus-section fade-up">
        ...
        <p>
          ...
          brimming with an extensive collection of books catering to both junior
          and senior students. With separate libraries for each age group, we
          provide a tailored learning experience. The Junior Library offers
          engaging storybooks, while the Senior Library includes literature,
          reference materials, and research resources. Our library staff
          supports every student’s journey of discovery and reading pleasure.
        </p>
      </div>
      ...
      <div className="campus-section fade-up">
        ...
        <p>
          ...
          lab is a dynamic space equipped with LEGO Mindstorms and Arduino kits,
      ...
      <div className="campus-section fade-up">
        ...
        <p>
          The Art and Craft Centre allows children to engage in art, craft, and
          ceramics, providing an outlet for creativity, imagination, and
          expression.
        </p>
      </div>
      ...
      <div className="campus-section fade-up">
        ...
        <p>
          Our Dance Studio offers students a platform to master Indian, Western,
          and contemporary dance forms, fostering cross-cultural learning and
      ...
      <div className="campus-section fade-up">
        ...
        <p>
          A vibrant place to learn cooking, sewing, meal planning, hospitality,
          flower arrangements, and other essential life skills.
        </p>
      </div>
